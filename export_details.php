                ...
                <div class="mainpanel">
					...
					<h5 style="padding-top:5px; padding-bottom:5px">Dowload Employee Details : </h5>
							...
							<!--<div class="row paddtop" style="margin-top:20px">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="control-label" class="col-sm-4 control-label"><b>Dowload Employee Details :</b> <span style="color:red;">*</span></label>
													</div>
												</div>
						...
						<div class="row paddtop" style="margin-top:20px">
                         ...
                         <div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												1. Download Employee Details <a href="download/download2.php">click here</a></br>
						...
						<!--<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-4" style="padding-left:15px">
   												...
   												3. Download LMS Details <a href="download3.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												2. Download Company Details <a href="download/download4.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												3. Download Associate Employee Details <a href="download/download5.php">click here</a></br>
						...
						<!--<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												6. Download Provisional Quotation Details <a href="download/download6.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												4. Download Apply Leave Details <a href="download/download7.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												5. Download Add Branch Details <a href="download/download8.php">click here</a> </br>
												
												</div>	
                                               <div class="col-sm-6" style="padding-right:15px">
											     
											
   												5. Download Add Branch Details <a href="download_pdf/pdf_add_branch.php">PDF</a> </br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												6. Download Add Category Details <a href="download/download9.php">click here</a></br>
												
												</div>
                                                 <div class="col-sm-6" style="padding-right:15px">
											     
											
   												6. Download Add Category Details <a href="download_pdf/pdf_add_category.php">PDF</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												7. Download Add Com Details <a href="download/download10.php">click here</a></br>
						...
						<!--<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												11. Download Add Property Location Details <a href="download/download11.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												12. Download Add Property Type Details <a href="download/download12.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-4" style="padding-left:15px">
   												...
   												13. Download Admin Details <a href="download/download13.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												8. Download Associate Designation Details <a href="download/download14.php">click here</a></br>
												
												</div>	
                                                <div class="col-sm-6" style="padding-right:15px">
											     
											
   												8. Download Associate Designation Details <a href="download_pdf/pdf_associate_designation.php">PDF</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												9. Download Attendance Details <a href="download/download15.php">click here</a></br>
					...
					<!--	<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-4" style="padding-left:15px">
   												...
   												16. Download Charts Details <a href="download/download16.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												10. Download Department Details <a href="download/download17.php">click here</a></br>
												
												</div>
                                                <div class="col-sm-6" style="padding-right:15px">
											     
											
   												10. Download Department Details <a href="download_pdf/pdf_department.php">PDF</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												11. Download Mark comp off Details <a href="download/download18.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												12. Download Recruitment Details <a href="download/download_recruitment.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												13. Download Hide Recruitment Details <a href="download/download_hide_recruitment.php">click here</a></br>
						...
						<!--<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												19. Download Total Lead Details <a href="download/download19.php">click here</a></br>
						...
						<div class="row paddtop" style="margin-top:20px">
                                                <div class="col-sm-6" style="padding-left:15px">
   												...
   												13. Download Expanses Details <a href="download/download_expanses.php">click here</a></br>
