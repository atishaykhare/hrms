...
<div class="col-sm-3" >
                                                <div class="form-group" >
                                                   ...
                                                   <input type="text" name="sales_exective_code" readonly id="exec_code" class="form-control"  placeholder="Sales Executive Code"/> 
                                                </div><!-- form-group -->
                                                </div>
...
$employeeid=$qq['employee_code'];
										...
										<select class="form-control select1"  readonly  name="sales_manger_code" id="l18">
													<?php
														foreach($arr as $v)
														{
															$quee=mysqli_query($con,"select * from add_employee where employee_code='$v'");
