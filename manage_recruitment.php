                ...
                <div class="mainpanel">
				 ...
				 <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Manage Recruitment :</h4>
                            ...
                            <table id="basicTable" class="table table-striped table-bordered responsive">
                                ...
                                <tbody>
								<?php
								$que=mysqli_query($con,"select * from recuriment");
						...
						while($res=mysqli_fetch_array($que))
						{
							...
							//$underwriter_code=$res['employee_underwriter'];
								...
								?>
                                    ...
                                    <tr>
                                        <td align="center"><?php echo $res['r_id']; ?></td>
                                        <td align="center"><?php echo $res['fname']." ".$res['lname']; ?></td>
                                        <td align="center"><?php echo $res['emp_department']; ?></td>
                                        <td align="center"><?php echo $res['emp_designation']; ?></td>
                                        <td align="center"><?php echo $res['interviewer_name']; ?></td>
                                        <td align="center"><?php echo $res['emp_branch']; ?></td>
										
										 <td align="center"><a href="update_recruitment?id='<?php echo $id; ?>'"><i class="fa fa-edit"></i></a></td>
										 <td align="center"><a href="delete_recruitment?id='<?php echo $id; ?>'"><i class="fa fa-close"></i></a></td>
                                    </tr>
                                  <?php } ?>
                                </tbody>
                            </table>
